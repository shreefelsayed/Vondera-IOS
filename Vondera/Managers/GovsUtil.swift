...
class GovsUtil {
    var govs = ["القاهرة", "القاهره - مدن جديده", "الجيزة", "الإسكندرية", "القليوبية", "الإسماعيلية", "أسيوط", "البحر الأحمر", "البحيرة", "بني سويف", "بورسعيد", "جنوب سيناء", "الدقهلية", "دمياط", "سوهاج", "السويس", "الشرقية", "شمال سيناء", "الغربية"]
